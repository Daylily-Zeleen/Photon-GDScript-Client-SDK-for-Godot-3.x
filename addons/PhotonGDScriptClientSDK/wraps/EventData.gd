...
#static func is_reuse_event_instance()->bool:
#	return load("../src/PhotonEventData.cs").get_ReuseRealtimeEventInstance()
#
#static func set_reuse_event_instance(reuse:bool)->void:
##	_Inernal.ReuseEventInstance = reuse
#	load("../src/PhotonEventData.cs").set_ReuseRealtimeEventInstance(reuse) #
...
#	_Inernal.SelfClass = load("res://addons/PhotonGDScriptClientSDK/wraps/EventData.gd")
