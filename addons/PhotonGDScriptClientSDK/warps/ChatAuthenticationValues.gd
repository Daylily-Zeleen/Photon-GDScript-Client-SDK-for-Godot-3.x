...
## </remarks>
class_name ChatAuthenticationValues
...
func copy_to(copy:ChatAuthenticationValues)->ChatAuthenticationValues:
...
func _to_string() -> String:
	return "[ChatAuthenticationValues:%d] %s"%[get_instance_id(), _base.ToString()]
...
const _Base:=preload("../src/PhotonChatAuthenticationValues.cs")
